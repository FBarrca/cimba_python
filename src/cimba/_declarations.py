...
class _Declarations:
    ...
    def values(self, *kinds: str, attribute: str) -> dict[str, Any]:
        """Map declared field names to one descriptor attribute."""
        get_value = attrgetter(attribute)
        return {field.name: get_value(field) for field in self.by_kind(*kinds)}
...
if TYPE_CHECKING:
    ...
    class Timeseries(int):
        ...
        def histogram(
            self, bins: int = 20, low: float = 0.0, high: float = 0.0
        ) -> int: ...
        def histogram_file(
            self,
            path: Handle,
    ...
    class _RecordedEntity(int):
        def report(self) -> int: ...
        def report_file(self, path: Handle, append: int = 1) -> int: ...
        def history(self) -> Timeseries: ...

    class Queue(_RecordedEntity):
        """cmb_buffer; default declares capacity."""

        def put(self, amount: int) -> int: ...
        def get(self, amount: int) -> int: ...
        def level(self) -> int: ...
        def space(self) -> int: ...
        def mean_level(self) -> float: ...

    class Resource(_RecordedEntity):
        ...
        def in_use(self) -> int: ...
        def held(self, process: Handle) -> int: ...
        def mean_in_use(self) -> float: ...

    class Pool(_RecordedEntity):
        """cmb_resourcepool; default declares capacity."""

        def acquire(self, amount: int) -> int: ...
        def release(self, amount: int) -> None: ...
        def preempt(self, amount: int) -> int: ...
        def available(self) -> int: ...
        def held(self, process: Handle) -> int: ...
        def in_use(self) -> int: ...
        def mean_in_use(self) -> float: ...

    class Store(_RecordedEntity):
        """cmb_objectqueue; default declares capacity."""

        def put(self, obj: int) -> int: ...
        def get(self) -> tuple[int, int]: ...
        def take(self) -> int: ...
        def length(self) -> int: ...
        def space(self) -> int: ...
        def position(self, obj: int) -> int: ...
    ...
    class ScheduledEvent(int):
        ...
        ``.schedule_at()``; distinct from the Event field handle itself."""

        def cancel(self) -> int: ...
        def reschedule(self, at: float) -> int: ...
    ...
    class _PQueueHandle(_RecordedEntity):
        """cmb_priorityqueue handle, one element of a ``sim.PQueues``
        field."""

        def put(self, obj: int, priority: int) -> int: ...
        def get(self) -> tuple[int, int]: ...
        def take(self) -> int: ...
        def length(self) -> int: ...
        def space(self) -> int: ...
        def position(self, entry: int) -> int: ...
        def reprioritize(self, entry: int, priority: int) -> None: ...
        def cancel(self, entry: int) -> int: ...
        def mean_length(self) -> float: ...
    ...
    class Trace(_Decl):
        def __new__(cls, *args, **kwargs):
            raise TypeError(
                "Trace(field) views are only available inside compiled model code"
            )
    ...
    class _Ref:
        ...
        def __class_getitem__(cls, target):
            return _RefHint(target, table=cls.table)
