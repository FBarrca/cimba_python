...
Python builds the same structured data and formats it to match the native
report:
...
:func:`cimba.reporting.format_report` reproduces the C tutorial's
...
.. literalinclude:: ../static/mm1_reporting_report.txt
   :language: none

The C API also has five-number printers for datasets and time series. In
Python, that is a structured value:
...
.. figure:: ../static/mm1_reporting_histogram.svg
   :alt: Generated duration-weighted queue length histogram.

   Duration-weighted queue length histogram generated by
   :func:`cimba.reporting.plot_histogram`.

.. figure:: ../static/mm1_reporting_pacf.svg
   :alt: Generated partial autocorrelation correlogram.

   Partial autocorrelation correlogram generated by
   :func:`cimba.reporting.plot_correlogram`.
...
.. figure:: ../../subprojects/cimba/images/tut_1_6.png
   :alt: M/M/1 queue average length compared with the theoretical curve.

   Average queue length by utilization, with confidence intervals from
   replicated trials.
