...
* Read :doc:`../about/c_library` when a Python concept needs native background.

The Python docs are intentionally a companion to the C documentation. If you
want the deeper design story behind stackful coroutines, event dispatching,
resources, and random number generation, see the `Cimba C background`_ and the
